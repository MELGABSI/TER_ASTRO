...
x_train = t.reshape((len(t), 1095, 1))
y_train = t.reshape((len(t), 1095, 1))


# In[8]:


input_sig = Input(batch_shape=(24,1095,1))
x0 = Conv1D(512,5, activation='relu', padding='valid')(input_sig)
x1_ = MaxPooling1D(2)(x0)
x = Conv1D(128,5, activation='relu', padding='valid')(input_sig)
x1 = MaxPooling1D(2)(x)
